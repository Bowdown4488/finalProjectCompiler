...
implements DocumentListener, TokenTypes
{
   ...
   public SyntaxHighlighter(int height, int width, Scanner scanner)
   {
      ...
      Font font = new Font("Monospaced", Font.PLAIN, 22/*getFont().getSize()*/);
      changeFont(font);
      initStyles();
   }
   ...
   private void initStyles()
   {
      ...
      changeStyle (NUMBER, Color.magenta.darker());
      changeStyle (PUNCTUATION, Color.black);
      changeStyle (COMMENT, Color.gray);
      changeStyle (START_COMMENT, Color.gray);
      changeStyle (MID_COMMENT, Color.gray);
      changeStyle (END_COMMENT, Color.gray);
      changeStyle (TAG, Color.blue, Font.BOLD);
      changeStyle (END_TAG, Color.blue, Font.BOLD);
      changeStyle (KEYWORD, Color.blue);
      changeStyle (KEYWORD2, Color.blue, Font.BOLD);
      changeStyle (IDENTIFIER, Color.green.darker());
      changeStyle (LITERAL, Color.magenta.darker(), Font.BOLD);
      changeStyle (STRING, Color.magenta.darker());
      changeStyle (CHARACTER, Color.magenta.darker());
      ...
      changeStyle (CONSTANT, Color.green);
