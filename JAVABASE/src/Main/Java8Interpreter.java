 ...
 */
public class Java8Interpreter<T> extends AbstractParseTreeVisitor<T> implements Java8ParserVisitor<T> {
	...
	class Class{
		String className;
		Map<String, Value> classSpace = new HashMap<>();
		Object classFields;
		Object classMethods;
	...
	public Java8Interpreter(inputFrame frame, String srccode){
		this.frame = frame;
...
//		localVariableStack.pop();
	...
	@Override public T visitMethodInvocation(Java8Parser.MethodInvocationContext ctx) {
		...
		Value returnVal = (Value)visit((Java8Parser.MethodBodyContext)func.functionBody);
		return (T) returnVal;
	}
	/**
	 * {@inheritDoc}
